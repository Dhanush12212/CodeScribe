...
import { FiLogIn, FiLogOut, FiInfo, FiAlertTriangle } from "react-icons/fi";
    ...
    <div className="w-full h-screen relative overflow-hidden bg-gradient-to-b from-gray-900 via-gray-800 to-black text-white">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-6 sm:px-0">
        ...
        <motion.div
          ...
          className="flex flex-col py-20 sm:py-40 items-center text-center gap-8 bg-white/10 backdrop-blur-xl p-8 sm:p-12 rounded-3xl shadow-xl border border-white/20"
        >
          ...
          <div className="flex mt-3 items-center gap-4">
            <input
              ...
              className="outline-none text-white text-center px-4 py-3 lg:text-xl md:text-lg w-full rounded-md shadow-md focus:ring-2 focus:ring-green-600 bg-transparent placeholder-gray-400 border border-white/20"
              value={roomId}
